...
# Quick Start Script for IoT Security Lab - Ubuntu VM Version
# This version skips Raspberry Pi detection for VM environments

echo "================================================"
echo "   IoT Security Lab - Quick Start Setup"
echo "   Ubuntu/VM Version"
echo "================================================"
echo ""
...
pip3 install flask flask-cors 2>/dev/null || pip3 install flask flask-cors --break-system-packages 2>/dev/null || pip3 install --user flask flask-cors
...
echo ""
echo "Then access it from your browser at:"
echo ""
echo "  http://$IP_ADDRESS:5000"
echo "  http://$HOSTNAME:5000"
echo "  http://localhost:5000 (if browsing locally)"
echo ""
